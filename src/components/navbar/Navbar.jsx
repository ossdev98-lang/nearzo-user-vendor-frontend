      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
                    ...
                    >
                      ...
                      <form onSubmit={handleManualLocationSubmit} className="flex gap-2">
                        <input
                          ...
                          className="flex-1 bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-2.5 outline-none focus:border-purple-500 dark:text-white text-sm"
                          required
                        />
          ...
          <div className="hidden md:flex flex-1 px-6">
            <motion.div
              whileHover={{ scale: 1.02 }}
              className="w-full flex items-center bg-gray-100 dark:bg-white/5 rounded-xl px-4 py-2.5 border border-gray-200 dark:border-white/10 focus-within:border-primary focus-within:ring-2 focus-within:ring-primary/10 transition-all duration-300"
            >
              ...
              <input
                ...
                className="ml-3 bg-transparent outline-none text-sm text-gray-700 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 w-full"
              />
            </motion.div>
          </div>
          ...
          <div className="flex items-center gap-3">
                ...
                {loginDropdownOpen && (
                  <>
                    ...
                    >
                      ...
                      <button 
                        onClick={() => { setLoginDropdownOpen(false); navigate('/login?role=vendor') }}
                        className="w-full text-left px-4 py-3 rounded-xl hover:bg-gray-50 dark:hover:bg-white/5 text-sm font-medium text-gray-700 dark:text-gray-200 transition-colors flex items-center gap-2"
                      >
            ...
            <motion.button
              ...
              className="md:hidden p-2.5 rounded-xl bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10"
            >
              {mobileOpen ? (
